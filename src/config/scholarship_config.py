...
Value = dict of overrides (all optional):
  ...
  locked_urls              : list  — if set, search engine is SKIPPED; only these URLs are scraped
                                     Use {year} placeholder for current calendar year substitution
  ...
  scrape_char_limit        : int   — override default 5000-char per-page truncation limit
  context_hint             : str   — operator-verified text injected into LLM prompt; used when
                                     page content is truncated or buried past char limit
